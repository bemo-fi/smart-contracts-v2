...
import {getAdminMultisigInternalPayload, getChangeCommissionFactorPayload} from "../wrappers/utils/AdminMultisigUtils";
...
export async function run(provider: NetworkProvider) {
    ...
    const payload = getChangeCommissionFactorPayload(20);
